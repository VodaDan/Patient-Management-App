...
public class LocalStack extends Stack {
    ...
    public LocalStack(final App scope, final String id, final StackProps props) {
        ...
        CfnHealthCheck patientsDbHealthCheck = createDbHealthCheck(patientServiceDb,"PatientServiceDBHealthCheck");
        ...
        FargateService authService = createFargateService("AuthService",
                ...
                List.of(4005),
                authServiceDb,
                Map.of("JWT_SECRET", "Aykgh3f5cYo6vmj3uEjY4UHyR7E7Vmmt6RSe1MB8znI="));
        ...
        FargateService patientService = createFargateService("PatientsService",
                "patient-service",
                List.of(4000),
                patientServiceDb,
                Map.of(
        ...
        patientService.getNode().addDependency(patientsDbHealthCheck);
